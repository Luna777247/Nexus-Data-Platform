...
# Purpose: Ingest data from any source defined in configs/sources.yaml

"""
Generic DAG for ingesting data from configured sources.

Advantages:
- Add new sources: Edit configs/sources.yaml only, no code changes
...
def load_sources_config():
    """Load data sources from configs/sources.yaml"""
